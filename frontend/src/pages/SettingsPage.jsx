          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <select value={getThemeValue()} onChange={handleThemeChange}
                className="px-3 py-2 border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-slate-100 rounded-lg text-sm outline-none focus:border-indigo-500 cursor-pointer">
            ...
            <div className="flex items-center justify-between">
              ...
              <select className="px-3 py-2 border border-gray-300 dark:border-slate-600 bg-white dark:bg-slate-700 text-gray-900 dark:text-slate-100 rounded-lg text-sm outline-none focus:border-indigo-500">
