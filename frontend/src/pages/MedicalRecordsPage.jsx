  ...
  return (
    <div className="space-y-6 max-w-7xl mx-auto">
      <div className="bg-white dark:bg-slate-800 p-6 rounded-2xl shadow-sm border border-gray-200 dark:border-slate-700">
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-gray-500 dark:text-slate-400 text-sm">View and manage patient medical records</p>
          </div>
        </div>
      </div>
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-200 dark:border-slate-700 p-12 flex flex-col items-center justify-center text-center">
        ...
        <h2 className="text-lg font-semibold text-gray-900 dark:text-white mb-2">Medical Records Module</h2>
        <p className="text-gray-500 dark:text-slate-400 max-w-md">Access and manage patient medical histories, lab results, imaging reports, and clinical documentation.</p>
      </div>
    </div>
  );
}
